...
$cabecalho_pdf .= "<img src='./imagens/celke.jpg' alt='Celke' width='60'>";
...
// Conteúdo do PDF
$conteudo_pdf = "<h1 style='font-size: 60px; text-align: center; padding-top: 180px;'>Avalie Nosso Atendimento</h1>";
$conteudo_pdf .= "<div style='text-align: center;'><img src='$qrcode'></div>";
//echo $conteudo_pdf;
